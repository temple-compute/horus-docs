...
<Tabs>
  <TabItem value="string" label="Ask for text" default>
...
```
  ...
  <TabItem value="confirm" label="Ask yes or no">
...
[Interaction reference](../sdk/core/interaction.md).

Next, [Running workflows](./running-workflows.md) covers the CLI and the live
dashboard.
