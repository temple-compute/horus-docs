...
[artifact substitution](../sdk/core/artifact-substitution.md) for the full
syntax.
...
[Extending Horus](./extending.md).

---

Next, put these together in [YAML](./writing-workflows-yaml.mdx) or
[Python](./writing-workflows-python.mdx). For the underlying models, see the
