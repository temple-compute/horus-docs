...
- Composite discriminator keys via [`AutoRegistryProduct`](/sdk/plugin-system/auto-registry-product) for
...
See [Auto-Registry Product](/sdk/plugin-system/auto-registry-product) for the full
