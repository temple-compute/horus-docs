...
`HorusContext` is the global runtime context for the Horus Runtime SDK. It is responsible for initializing the runtime environment, loading plugins, and exposing shared runtime state, including the [Event Bus](/sdk/event_system), to all other components.
