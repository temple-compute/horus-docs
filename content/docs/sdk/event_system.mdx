...
All runtime components and task implementations access the bus through the [Runtime Context](/sdk/context):
...
<Callout type="info" title="Source inference">
...
<Callout type="info" title="Event registration is optional">
...
For a complete reference on the plugin registration mechanism, see [AutoRegistry](/sdk/plugin-system/autoregistry).
