...
<Tabs items={["Hello (YAML)", "Pipeline (YAML)", "Hello (Python)", "Interactive (Python)"]}>
  <Tab value="Hello (YAML)">
...
[Writing workflows in YAML](/guides/writing-workflows-yaml#a-complete-example).

  </Tab>
  <Tab value="Hello (Python)">
...
See [Writing workflows in Python](/guides/writing-workflows-python) for the full
listing and explanation.

  </Tab>
  <Tab value="Interactive (Python)">
...
See [Prompting the user](/guides/writing-workflows-python#prompting-the-user).
